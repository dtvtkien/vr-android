...
public class ProjectionModeManager extends ModeManager<AbsProjectionStrategy> implements IProjectionMode {
    ...
    protected AbsProjectionStrategy createStrategy(int mode) {
        ...
        switch (mode) {
            ...
            case MDVRLibrary.PROJECTION_MODE_HEMISPHERE:
                return new HemisphereProjection();
            case MDVRLibrary.PROJECTION_MODE_STEREO_HEMISPHERE:
                return new StereoHemisphereProjection(MDDirection.HORIZONTAL);
