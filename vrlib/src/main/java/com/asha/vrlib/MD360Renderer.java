...
import com.asha.vrlib.type.MDVideoRender;
...
public class MD360Renderer implements GLSurfaceView.Renderer {
    ...
    public static class Builder {
        ...
        public Builder setVideoType(int type) {
            this.videoType = type;
            return this;
        }
