package com.appixiplugin.vrplayer.custom;
...
public class CircleProgressBar extends View {
    ...
    private int min = 0;
    private int max = 100;
    private int animatedDurationInSeconds = 3;
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            animatedDurationInSeconds = typedArray.getInt(R.styleable.CircleProgressBar_animatedDurationInSeconds, animatedDurationInSeconds);
        } finally {
            typedArray.recycle();
        }
    ...
    public void setProgressWithAnimation(float progress) {
        ...
        progressAnimator.setDuration(animatedDurationInSeconds * 1000);
