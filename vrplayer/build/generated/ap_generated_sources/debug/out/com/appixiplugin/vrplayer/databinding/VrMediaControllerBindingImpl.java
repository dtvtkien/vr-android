...
public class VrMediaControllerBindingImpl extends VrMediaControllerBinding implements com.appixiplugin.vrplayer.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.view_3d_blur, 17);
        sViewsWithIds.put(R.id.view_center_left_eye, 18);
        sViewsWithIds.put(R.id.view_center_right_eye, 19);
        sViewsWithIds.put(R.id.cp_left_eye, 20);
        sViewsWithIds.put(R.id.cp_right_eye, 21);
    }
    // views
    // variables
    @Nullable
    ...
    private VrMediaControllerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View[] root, Object[] bindings) {
        super(bindingComponent, root[0], 0
            ...
            , (com.appixiplugin.vrplayer.custom.CircleProgressBar) bindings[20]
            , (com.appixiplugin.vrplayer.custom.CircleProgressBar) bindings[21]
